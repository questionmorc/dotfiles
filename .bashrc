...
eval "$(oh-my-posh init bash --config '~/oh-my-posh-themes/mrrc.json')"
alias config="/usr/bin/git --git-dir=$HOME/.cfg/ --work-tree=$HOME"

export PATH=$PATH:~/bin

if [ -e /home/mrrc/.nix-profile/etc/profile.d/nix.sh ]; then . /home/mrrc/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
eval # =============================================================================
#
